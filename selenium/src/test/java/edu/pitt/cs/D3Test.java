...
public class D3Test {
  ...
  public void tEST5RENTACAT() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/main/div[1]/div[3]/div[3]/button")));
    }
    {
  ...
  public void tEST11GREETACATWITHNAME() {
    ...
    assertThat(driver.findElement(By.xpath("/html/body/div/main/div[1]/div[2]/h4")).getText(), is("Meow! from Jennyanydots."));
  }
  // @Test
  ...
  //   }
  //   assertThat(driver.findElement(By.xpath("//*[@id=\'feedResult\' and text()=\'Cat fight!\']")).getText(), is("failure"));
  // }
  // @Test
